...
class DongdongSpider(scrapy.Spider):
    ...
    url = 'http://www.dacai.com/news/bd/zjyc/list'
    offset = 1
    start_urls = [url+'1.html']


    def parse(self, response):
        # 每一页里的所有帖子的链接集合
        links = response.xpath('//div[@class="container"]//li//a/@href').extract()
    ...
    def parse_item(self, response):
        ...
        item['title'] = response.xpath('//div[@class="z_left"]//div[@class="newstitle"]//h1/text()').extract()[0]
        # 时间
